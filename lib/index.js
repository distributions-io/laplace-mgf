...
function mgf( t, options ) {
	...
	if ( isMatrixLike( t ) ) {
		...
		return mgf5( out, t, opts.mu, opts.b );
	}
	if ( isTypedArrayLike( t ) ) {
		...
		return mgf6( out, t, opts.mu, opts.b );
	}
	if ( isArrayLike( t ) ) {
		// Handle deepset first...
		if ( opts.path ) {
			opts.sep = opts.sep || '.';
			return mgf4( t, opts.mu, opts.b, opts.path, opts.sep );
		}
		...
		if ( opts.accessor ) {
			return mgf3( out, t, opts.mu, opts.b, opts.accessor );
		}
		return mgf2( out, t, opts.mu, opts.b );
	}
	return NaN;
} // end FUNCTION mgf()
